                ...
                if (f.display_gallery)
                    if ("undefined" != typeof c.is_private && !0 === c.is_private)
                        ...
                        for (var m = 0; m < s; m++) {
                            ...
                            j += "<div class='item'><div class='animation-container'><img class='instagram-img'" + (f.lazy_load ? " loading='lazy'" : "") + " src='" + n + "' alt='" + b(p) + "'" + e.gallery_image + "/><div class='insta-overlay'><div class='img-info'><p>" + b(p) + "</p></div><div class='likes'><img src='./files/img/icons/heart.svg' class='icon-sml'/><p>" + l[m].node.edge_liked_by.count + "</p></div></div></div></div>",
                            j += "</a>"
                        }
                        j += "</div>"
                    }
